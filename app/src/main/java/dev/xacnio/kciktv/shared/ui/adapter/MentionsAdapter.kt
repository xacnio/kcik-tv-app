...
class MentionsAdapter(
    ...
    inner class MentionViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val deleteButton: View = view.findViewById(R.id.deleteMentionButton)
        ...
        fun bind(message: ChatMessage) {
            ...
            message.metadata?.originalSender?.let { sender ->
                ...
                EmoteManager.renderEmoteText(replyContent, replyText, replyEmoteSize)
            } ?: run {
            ...
            EmoteManager.renderEmoteText(messageContent, message.content, emoteSize)
