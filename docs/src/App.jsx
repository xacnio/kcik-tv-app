...
const featureCategories = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Vibrate, sound & push on mention' },
      { name: 'Highlights: own, mod, VIP & OG' },
      { name: 'Fill-background highlight mode' },
      { name: 'Message entry animations' },
      { name: 'Adjustable text & emote size' },
      { name: 'Timestamps' },
      { name: 'Floating emotes & combos' },
      { name: 'Quick emote bar (recents)' },
      { name: 'Emote panel: Global / Channel / Emoji / Collectibles' },
      { name: 'Pinned messages' },
      { name: 'Pinned gift banners' },
      { name: 'Celebration banners' },
      { name: 'Background buffering + load-missed' },
      { name: 'Nick detection (alerts without @)' },
  ...
  },
  {
    ...
    mock: 'identity',
    items: [
      { name: 'Account levels & level badge' },
      { name: 'Animated XP progress' },
      { name: 'badges_v2 support' },
      { name: 'Global vs channel badge split' },
      { name: 'Pick up to 4 visible badges' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Reward request queue' },
      { name: 'Mod emote channels' },
    ],
  },
  {
    label: 'Engagement',
    ...
    mock: 'rewards',
    items: [
      { name: 'Daily Reward — claim & roulette spin', new: true },
      { name: 'Collectibles inventory page', new: true },
  ...
  },
  {
    ...
    items: [
      { name: 'Interactive featured hero' },
      { name: 'Recently-watched row' },
      { name: 'Warm-start Following tab' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Seamless switch (no chat reset)' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Per-surface battery controls' },
      { name: 'Thermal / adaptive performance' },
